<template>
  <div id="EmailView" class="bg-gray-50 h-screen">
      ...
      <div class="flex w-full justify-between">
        ...
        >
          ...
          <input
            ...
            class="w-full h-10 bg-gray-200 border-transparent border-none focus:ring-0 outline-none placeholde-gray-900"
            type="text"
          />
          <IconComponent
            iconString="tune"
    ...
    <div class="flex w-full justify-between">
      ...
      <!-- Burası sayfanın değiştirdiği yer -->
      <router-view />
      <!-- Burası sayfanın değiştirdiği yer -->
      <div class="m-4">
...
import StarOutlineIcon from "vue-material-design-icons/Star.vue";
import ClockOutlineIcon from "vue-material-design-icons/Clock.vue";
import SentOutlineIcon from "vue-material-design-icons/SendOutline.vue";
